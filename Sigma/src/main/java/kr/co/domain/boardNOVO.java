...
public class boardNOVO implements Serializable{
	...
	public boardNOVO(int num, String title, String content, String writer, String regidate, String updatedate,
