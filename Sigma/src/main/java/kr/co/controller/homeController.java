...
//      return "redirect:/sboard/read?bno="+vo.getBno()+"&curPage="+sto.getCurPage()+"&perPage"+sto.getPerPage()+"&searchType="+sto.getSearchType()+"&keyword="+sto.getKeyword();
   ...
   //======================================gameDetail============================================
      ...
      @RequestMapping(value = "/maincategoryDCRqSet", method = RequestMethod.GET)
      ...
      @ResponseBody
      @RequestMapping(value = "/maincategoryDCRqSet", method = RequestMethod.POST)
      ...
      @RequestMapping(value = "/maincategoryreviewupdate", method = RequestMethod.GET)
      ...
      @ResponseBody
      @RequestMapping(value = "/maincategoryreviewupdate", method = RequestMethod.POST)
