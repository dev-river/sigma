...
public class boardEVVO implements Serializable{
	...
	public boardEVVO(int num, String title, String content, String writer, String regidate, String updatedate,
