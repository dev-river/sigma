...
public class boardOVO implements Serializable{
	...
	public boardOVO(int num) {
		super();
		this.num = num;
	}

	public boardOVO(int num, String title, String content, String writer, String regidate, String updatedate,
